...
export default function SignIn(){
  ...
  return (
    <>
      <div className='singin' Style='centered-text'>

        Full Name<input type="text" value={searchName} onChange={(e) => setSearchName(e.target.value)} /><br/>
        ID<input type="text" value={searchIdCard} onChange={(e) => setSearchIdCard(e.target.value)} /><br/>
